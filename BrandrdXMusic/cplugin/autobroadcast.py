...
START_IMG_URLS = "https://graph.org/file/31a4f9664ca946f186e18.jpg"

MESSAGES = f"""**ㅤㅤㅤ⚠️⚠️⚠️⚠️⚠️📡

❤️Join Our Group For Study Related Doubt⭐️


🫂Link:- https://t.me/+MLyP0hnyKIk5ZWM9 ✅
...
🔐ᴜꜱᴇ » [/start](https://t.me/TriGO_v2_Music_bot?start=help) ᴛᴏ ᴄʜᴇᴄᴋ ʙᴏᴛ

➲ ʙᴏᴛ :** @TriGO_v2_Music_bot"""
...
BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "๏ ᴋɪᴅɴᴀᴘ ᴍᴇ ๏",
                url=f"https://t.me/TriGO_v2_Music_bot?startgroup=s&admin=delete_messages+manage_video_chats+pin_messages+invite_users",
            )
        ]
    ]
)
