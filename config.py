...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002248057838"))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002248057838"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/TeamTriGOofficial")
